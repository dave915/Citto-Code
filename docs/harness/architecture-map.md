...
- 팀/서브에이전트: `src/components/team/*`, `src/components/team/TeamViewParts.tsx`, `src/components/team/TeamSetupModalParts.tsx`, `src/hooks/useAgentTeam.ts`, `src/hooks/useSubagentStreams.ts`
