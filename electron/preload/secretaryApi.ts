...
export const secretaryAPI: SecretaryAPI = {
  ...
  listAutomationProfiles: () => ipcRenderer.invoke('secretary:list-automation-profiles'),
  saveAutomationProfile: (profile) => ipcRenderer.invoke('secretary:save-automation-profile', { profile }),
  deleteAutomationProfile: (id) => ipcRenderer.invoke('secretary:delete-automation-profile', { id }),
