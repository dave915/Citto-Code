  ...
  return (
    <>
      {attachedFiles.length > 0 && (
        <div className="mb-3 flex flex-wrap gap-1.5">
          {attachedFiles.map((file) => (
            <div key={file.path} className="flex items-center gap-1.5 rounded-lg border border-claude-border bg-claude-surface px-3 py-1.5 text-xs">
      ...
      {skippedFiles.length > 0 && (
        <div className="mb-2 rounded-lg border border-yellow-500/30 bg-yellow-500/10 px-3 py-2 text-xs text-yellow-700 dark:text-yellow-400">
