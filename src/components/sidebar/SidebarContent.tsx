  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between gap-3 pl-2 pr-1 py-0.5">
          ...
          <div ref={menuRootRef} className="flex items-center gap-1">
            ...
            <div className="relative">
              ...
              {openMenu === 'display' && (
                <AppPanel className="absolute left-0 top-[calc(100%+0.4rem)] z-30 w-56 overflow-hidden rounded-lg p-0 shadow-none">
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-2.5 pb-2.5">
            ...
            <section key={group.cwd} className="space-y-0.5">
              ...
              >
                <button
                  ...
                  className="flex min-w-0 flex-1 items-center gap-2 rounded-lg px-1 py-1 text-left text-claude-text outline-none focus:outline-none focus-visible:ring-1 focus-visible:ring-claude-orange/35 hover:text-claude-text"
                >
                  <svg
                ...
                <button
                  ...
                  className="flex-shrink-0 rounded-lg p-1.5 text-claude-muted/60 outline-none focus:outline-none focus-visible:ring-1 focus-visible:ring-claude-orange/35 hover:bg-claude-surface hover:text-claude-text"
        ...
        {threadCount === 0 && (
          <div className="rounded-md border border-dashed border-claude-border px-3 py-4 text-center text-[13px] text-claude-muted/65">
